...
r_{\perp} = 2\frac{\sin^2(\theta_1-\theta_2)}{\sin^2(\theta_1+ \theta_2)}
\end{equation}
...
Observe também que as equações [](#eq:rperp) e [](#eq:rparallel)  são simétricas se trocarmos a ordem dos meios. Isso implica que a interface  de forma igual em ambos os lados.
