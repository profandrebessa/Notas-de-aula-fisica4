...
Observe também que as equações \eqref{eq:rperp} e \eqref{eq:rparallel}
} são simétricas se trocarmos a ordem dos meios. Isso implica que a interface  de forma igual em ambos os lados.
